...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-brand-black text-brand-white relative overflow-hidden">
            <div className="absolute top-[-20%] left-[-10%] w-[600px] h-[600px] bg-brand-gold/10 rounded-full blur-[120px] pointer-events-none" />
            <div className="absolute bottom-[-20%] right-[-10%] w-[600px] h-[600px] bg-indigo-900/20 rounded-full blur-[120px] pointer-events-none" />
                ...
                <GlassCard className="p-8 md:p-10 border-white/10 bg-white/5">
                    ...
                    <form className="space-y-6" onSubmit={onSubmit}>
                        ...
                        <div className="text-center mt-4">
                            <Link to="/register" className="text-sm font-medium text-brand-gold hover:text-brand-white transition-colors flex items-center justify-center gap-1 group">
                                Don't have an account? Sign up <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform" />
                            </Link>
                        </div>
                    </form>
                </GlassCard>
